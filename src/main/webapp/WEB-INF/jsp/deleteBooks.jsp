    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">도서삭제</h1>
                <p class="mb-4">도서를 삭제할수 있습니다. <br> 도서코드를 통해 삭제가 가능합니다.</p>

                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">도서삭제</h6>
                    </div>
                    <div class="card-body">
                            ...
                            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <table>
                                    <tr>
                                        <th>도서 코드</th>
                                        <td>
                                            <input name="book_id" value="도서코드입력">
                                        </td>
                                        <td>
                                            <input type="button" id="btm" value="도서 삭제" onclick="deleteBook(this.form)">
                                        </td>
                                    </tr>
                                </table>
                            </form>
...
<script type="text/javascript">
    ...
    function deleteBook(frm){
        var isRental = confirm("정말 삭제처리 하시겠습니까?")
        if(isRental){
            alert("삭제되었습니다")
