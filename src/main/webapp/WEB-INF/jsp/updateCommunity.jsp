...
<div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
        	...
        	<tr>
        		<td>
        			<input type="hidden" name="community_id" value="${modify.community_id }">
        		</td>
        	</tr>
            <tr>
	           	<th>제목</th>
	           	<td>
					<input type = "text" name = "title" size="45" title = "도서제목" value="${modify.title }">
                </td>
            </tr>
            <tr>
                <th>별점</th>
	                <td>
						<!-- id = "log" -->
						<select name="score" title="별점" value="${modify.score }">
            ...
            <tr>
                <th>한줄평</th>
	                <td>
						<input type = "text" name = "review" size="45" title = "한줄평" value="${modify.review }">
					</td>
            </tr>
            ...
            <tr>
                <th>내용</th>
                <td>
					<textarea type = "text" name = "content" size="45" title = "글내용" id="textBox">${modify.content }</textarea>
				</td>
            </tr>
        	</c:if>
            </tbody>
            ...
            <tr>
                <td colspan="3" id="btns">
                    <input type="button" value="수정확인" onclick="fn_updateCommunity(this.form)" id="btn">
...
function fn_updateCommunity(frm){
	var isUpdate = confirm
	if(isUpdate){
		alert("수정 되었습니다")
		frm.action = "/updateCommunity";
		frm.submit();
	}
}
    ...
    <form method="post" name="frm">
        <table>
            ...
            <tr>
                <th>내용</th>
                <td>
					<textarea type = "text" name = "content" size="45" title = "글내용">${modify.content }</textarea>
				</td>
            </tr>
        	</c:if>
            </tbody>
            ...
            <tr>
                <td colspan="3">
                    <input type="button" value="수정확인" onclick="fn_updateCommunity(this.form)">
                    <input type="button" value="삭제" onclick="fn_deleteCommunity(this.form)">
                </td>
            </tr>
            </tfoot>
        </table>
