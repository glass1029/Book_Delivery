    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">나의 게시글</h1>
                <p class="mb-4">내가 쓴 글을 조회할 수 있습니다. <br> 글 제목을 누르면 수정페이지로 넘어갑니다.</p>

                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">나의 게시글</h6>
                    </div>
                    <div class="card-body">
