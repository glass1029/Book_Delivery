                            ...
                            <form method="post" name="frm">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <th>제목</th>
                                        <td>
                                            <input id="textBox" type="text" name="title" size="45" title="제목" value="${notice.title}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>작성자</th>
                                    ...
                                    <tr>
                                        <th>내용</th>
                                        <td>
                                            <textarea name="content" rows="8" cols="50" title="내용" >${notice.content}</textarea>
                                        </td>
                                    </tr>
                                    </tbody>
                                    <tfoot>
                                    <tr>
                                        <td colspan="3" id="btns">
                                            <input id="btn" type="button" value="글수정" onclick="update_go(this.form)">
                                            <input id="btn" type="reset" value="초기화">
                                            <input id="btn" type="button" value="목록" onclick="list_go()">
                                        </td>
                                    </tr>
                                    </tfoot>
                                </table>
...
<script>
    ...
    function list_go(){
        var isReturnList = confirm("수정한 내용을 저장하지 않고 목록으로 돌아가겠습니까?")
        if(isReturnList) {
