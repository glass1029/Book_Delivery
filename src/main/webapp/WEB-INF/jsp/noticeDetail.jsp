...
<head>
    <style>
        ...
        #adminNoticeUpdate, #adminNoticeDelete, #btn {
        ...
        #adminNoticeUpdate:hover, #adminNoticeDelete:hover, #btn:hover {
                            ...
                            <form method="post" name="frm">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        <th>No.</th>
                                        <th>${ notice.notice_id}
                                            <input type="hidden" name="notice_id" value="${ notice.notice_id}"></th>
                                        <th>작성자</th>
                                        <th>관리자</th>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3"><div align="left" >
                                            <pre style="font-family:맑은고딕">${ notice.content}</pre></div></td>
                                    </tr>
                                    </tbody>
                                    ...
                                    <tr>
                                        <td colspan="4" id="btns">
                                            <input type="button" value="수정" id="adminNoticeUpdate" href=# onclick="modify_go(this.form)">
                                            <input type="button" value="삭제" id="adminNoticeDelete" href=# onclick="remove_go(this.form)">
                                            <input type="button" value="목록" id="btn" onclick="list_go()">
                                        </td>
                                    </tr>
                                    </tfoot>
                                </table>
...
<script>
    function modify_go(frm) {
        if (loginId !== 'admin'){
            ...
            document.getElementById('adminNoticeUpdate').innerHTML='';
        } else {
            document.location.href="/noticeModify?notice_id=${notice.notice_id}";
        }
    }
    function remove_go(frm) {
        if (loginId !== 'admin'){
            alert("공지사항은 관리자만 삭제할 수 있습니다.")
            document.getElementById('adminNoticeDelete').innerHTML='';
        } else {
            var isRight = confirm("공지를 삭제하겠습니까?");
            if(isRight) {
                alert("공지 삭제가 완료되었습니다.");
                frm.action = "/noticeDelete?notice_id=${notice.notice_id}";
                frm.submit();
            }
        }
    }
