    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <p class="mb-4">세상의 모든 책을 만날 수 있는 세모 도서관에 오신 것을 환영합니다!<br>공지사항에서 도서관 소식을 확인해주세요.</p>

                <!-- DataTales Example -->
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">도서관 소식</h6>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table data-order='[[0, "desc"]]' class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <c:if test="${ empty noticeList}">
                                    <tr><td colspan="4">공지사항 데이터가 없습니다.</td></tr>
                                </c:if>
                                <c:if test="${ not empty noticeList}">
                                <c:forEach items="${ noticeList}" var="notice">
                                <tr>
                                    <td>${notice.notice_id}</td>
                                    <td><a href="/noticeDetail?notice_id=${notice.notice_id}" id="detail">${notice.title}</a></td>
                                    <td>관리자</td>
                                ...
                                <tr>
                                    ...
                                    <td colspan="5" id="btns">
                                        <input type="button" value="공지쓰기" id="adminNotice" href=# onclick="write_go(this.form)">
                                    </td>
                                </tr>
                                </tfoot>
...
<script type="text/javascript">
    ...
    function write_go(frm){
        if (loginId !== 'admin'){
            ...
            document.location.href="/noticeWrite";
        }
    }
</script>
<script type="text/javascript">
