    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <p class="mb-4">도서를 검색하여 조회할 수 있습니다. (도서명 가나다순 정렬) <br> 도서명을 누르면 상세페이지에서 대출신청을 할 수 있습니다.</p>
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        ...
                        <c:if test="${ not empty searchCondition && not empty searchKeyword}">
                            <c:choose>
                                <c:when test="${ searchCondition eq 'book_name'}">
                                    카테고리 <b>[도서명]</b> &nbsp;
                                </c:when>
                                <c:when test="${ searchCondition eq 'writer'}">
                                    카테고리 <b>[저자]</b> &nbsp;
                                </c:when>
                                <c:when test="${ searchCondition eq 'publisher'}">
                                    카테고리 <b>[출판사]</b> &nbsp;
                                </c:when>
                            </c:choose>
                                        ...
                                        <ol class="paging">
                                                ...
                                                <c:otherwise>
                                                    <li>
                                                        ...
                                                        <c:if test="${ not empty searchCondition && not empty searchKeyword}">  <!--검색 키워드 있을 때-->
                                                            <a href="/books?searchCondition=${ searchCondition}&searchKeyword=${ searchKeyword}&curPage=${ paging.startPage-1}">이전으로</a>
                                                        </c:if>
                                                    </li>
                                                </c:otherwise>
                                            </c:choose>
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <li>
                                                            ...
                                                            <c:if test="${ not empty searchCondition && not empty searchKeyword}">  <!--검색 키워드 있을 때-->
                                                                <a href="/books?searchCondition=${ searchCondition}&searchKeyword=${ searchKeyword}&curPage=${pageNo}">${pageNo}</a>
                                                            </c:if>
                                                        </li>
                                                    </c:otherwise>
                                                </c:choose>
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <li>
                                                        <c:if test="${ empty searchCondition && empty searchKeyword}">  <!--검색 키워드 없을 때-->
                                                            <a href="/books?curPage=${ paging.endPage+1}">다음으로</a>
                                                        </c:if>
                                                        <c:if test="${ not empty searchCondition && not empty searchKeyword}">  <!--검색 키워드 있을 때-->
                                                            <a href="/books?searchCondition=${ searchCondition}&searchKeyword=${ searchKeyword}&curPage=${ paging.endPage+1}">다음으로</a>
                                                        </c:if>
                                                    </li>
                                                </c:otherwise>
                                            </c:choose>
