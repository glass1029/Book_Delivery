                        ...
                        <div class="table-responsive">
                            <form method="post" name="frm">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    <tr>
                                        <input type="hidden" name="member_id" id="member_id" value="${myInfo.member_id}">
                                        <th>아이디</th>
                                        <td><input id="textBox" type="text" name="id" value="${myInfo.id}" disabled></td>
                                    </tr>
                                    <tr>
                                        <th>비밀번호</th>
                                        <td><input id="textBox" type="password" name="password" value="${myInfo.password}"></td>
                                    </tr>
                                    <tr>
                                        <th>이름</th>
                                        <td><input id="textBox" type="text" name="name" value="${myInfo.name}" disabled></td>
                                    </tr>
                                    <tr>
                                        <th>주소</th>
                                        <td><input id="textBox" type="text" name="address" value="${myInfo.address}"></td>
                                    </tr>
                                    <tr>
                                        <th>이메일</th>
                                        <td><input id="textBox" type="text" name="email" value="${myInfo.email}"></td>
                                    </tr>
                                    <tr>
                                        <th>전화번호</th>
                                        <td><input id="textBox" type="text" name="phone" value="${myInfo.phone}"></td>
                                    </tr>

                                    </tbody>
                                    <tfoot>
                                    <tr>
                                        <td id="btns" colspan="6">
                                            <input id="btn" type="button" value="정보수정" onclick="modify_go(this.form)">
                                        </td>
                                    </tr>
                                    </tfoot>
                                </table>
...
<script>
    function modify_go(frm) {
        var isModify = confirm("입력한 정보로 회원 정보를 수정하겠습니까?");
        if(isModify) {
            alert("회원정보를 수정했습니다. 메인 페이지로 이동합니다.");
            frm.action = "/myInfoUpdate";
            frm.submit();
        }
    }
</script>
