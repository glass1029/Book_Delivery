    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">회원 정보 확인</h1>
                <p class="mb-4">회원정보를 수정하기 전 비밀번호를 다시 입력해주세요.</p>
                        ...
                        <div class="tableresponsive">
                                ...
                                <form method="post" name="frm">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <tr>
                                            <th>비밀번호 확인</th>
                                            <td><input id="textBox" type="password" name="password"></td>
                                        </tr>
                                        </tbody>
                                        <tfoot>
                                        <tr>
                                            <td colspan="2" id="btns">
                                                <input id="btn" type="button" onclick="fn_pwCheck(this.form)" value="확인">
                                            </td>
                                        </tr>
                                        </tfoot>
                                    </table>
