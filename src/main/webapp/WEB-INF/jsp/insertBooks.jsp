    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800">도서등록</h1>
                <p class="mb-4">도서를 등록할 수 있습니다. <br> 도서명과 저자 출판사를 입력해주세요.</p>
                ...
                <tr>
                    <th>출판사</th>
                    <td>
                        <input name="publisher" value="">
                    </td>
                </tr>
                <tr>
                    <th>서적 등록</th>
                        <td>
                            <input type="button" id="btn" value="서적 등록" onclick="insertBook(this.form)">
                        </td>
                </tr>
                            </table>
                            </form>
