            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">글작성</h6>
                    </div>
                    <div class="card-body">
                            ...
                            <form method = "post" name="frm">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        <th>말머리</th>
                                        <td>
                                            <select name="category" title="말머리">
                                                <option value="기억에 남는 구절">기억에 남는 구절</option>
                                                <option value="도서후기">도서 후기</option>
                                            </select>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type = "button" id="btn" value="책검색" onclick="fn_bookName(this.form)">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>글제목</th>
                                        <td>
                                            <input type = "text" name = "title" size="100" title = "글제목" >
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>글내용</th>
                                        <td>
                                            <input  type = "text" name = "content" size="100" title = "글내용" id="content">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>한줄평</th>
                                        <td>
                                            <input type = "text" name = "review" size="100" title = "한줄평" >
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>별점</th>
                                    ...
                                    <tr>
                                        <th>글 등록</th>
                                        <td>
                                            <input type="button" id="btn" value="글 등록" onclick="fn_insertCommunity(this.form)">
