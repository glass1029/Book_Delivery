            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">건의사항 글쓰기</h6>
                    </div>
                    <div class="card-body">
                            ...
                            <form method="post" name="frm">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tr>
                                        <th>제목</th>
                                        <td>
                                            <input type="text" name="title" size="45" title="제목" id="textBox">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>작성자</th>
                                        <td>
                                            <input type="text" name="id" value="#" id="s_id" disabled>
                                            <input type="hidden" name="member_id" value="#" id="s_member_id">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>내용</th>
                                    ...
                                    <tr>
                                        <td colspan="3" id="btns">
                                            <input type="button" value="글쓰기" onclick="insertData(this.form)" id="btn">
...
<script>
    ...
    //글쓴이
    document.getElementById('s_id').value=loginId;
    document.getElementById('s_member_id').value=memberId;
